...
=========================================================================*/
// .NAME vtkmpjX3DExporter - create an x3d file
// .SECTION Description
// vtkmpjX3DExporter is a render window exporter which writes out the renderered
...
#ifndef __vtkmpjX3DExporter_h
#define __vtkmpjX3DExporter_h
...
class vtkmpjX3DExporter : public vtkExporter
{
public:
  static vtkmpjX3DExporter *New();
  vtkTypeMacro(vtkmpjX3DExporter,vtkExporter);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Specify which Renderer to use. Default is 0.
...
private:
  ...
  vtkmpjX3DExporter(const vtkmpjX3DExporter&); // Not implemented.
  void operator=(const vtkmpjX3DExporter&); // Not implemented.
};
