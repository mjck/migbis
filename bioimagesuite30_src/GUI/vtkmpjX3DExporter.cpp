...
static void vtkmpjX3DExporterWriteData(vtkPoints *points, 
  vtkDataArray *normals,
  vtkDataArray *tcoords, 
  vtkUnsignedCharArray *colors,
  int index, vtkX3DExporterWriter* writer);
static void vtkmpjX3DExporterUseData(bool normals, bool tcoords, bool colors, int index, 
  vtkX3DExporterWriter* writer);

static bool vtkmpjX3DExporterWriterUsingCellColors(vtkActor* anActor)
{
  int cellFlag = 0;
...
//----------------------------------------------------------------------------
static bool vtkmpjX3DExporterWriterRenderFaceSet(
  int cellType,
  int representation,
  vtkPoints* points,
  ...
  bool common_data_written, int index, vtkX3DExporterWriter* writer)
{
  ...
  if (!common_data_written)
    {
    vtkmpjX3DExporterWriteData(points, normals, tcoords, colors, index, writer);
    }
  else
    {
    vtkmpjX3DExporterUseData((normals != NULL), (tcoords != NULL), (colors!= NULL), index, writer);
    }
...
static bool vtkmpjX3DExporterWriterRenderVerts(
...
static bool vtkmpjX3DExporterWriterRenderPoints(
  vtkPolyData* pd, 
  vtkUnsignedCharArray* colors,
  bool cell_colors
  ,  vtkX3DExporterWriter* writer)
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkmpjX3DExporter);

//----------------------------------------------------------------------------
vtkmpjX3DExporter::vtkmpjX3DExporter()
{
  this->Renderer = 0;
  this->Speed = 4.0;
  this->FileName = NULL;
...
//----------------------------------------------------------------------------
void vtkmpjX3DExporter::WriteData()
{
  ...
  if (this->Renderer)
    ...
    //ren = static_cast<vtkRenderer *>(this->RenderWindow->GetRenderers()->GetItemAsObject(this->Renderer));
...
//----------------------------------------------------------------------------
void vtkmpjX3DExporter::WriteALight(vtkLight *aLight,
  vtkX3DExporterWriter* writer)
{
...
//----------------------------------------------------------------------------
void vtkmpjX3DExporter::WriteAnActor(vtkActor *anActor,
  vtkX3DExporterWriter* writer, int index)
{
  ...
  mapper->SetUseLookupTableScalarRange(anActor->GetMapper()->GetUseLookupTableScalarRange());
  ...
  bool cell_colors = vtkmpjX3DExporterWriterUsingCellColors(anActor);
  ...
  if (representation == VTK_POINTS)
    ...
    if (true)
      ...
      vtkmpjX3DExporterWriterRenderPoints(pd, colors, cell_colors, writer);
      writer->EndNode();
      }
    }
  else
    ...
    if (numPolys > 0)
      ...
      this->WriteAnAppearance(anActor, writeEmissiveColor, writer);
      // Write Geometry
      vtkmpjX3DExporterWriterRenderFaceSet(VTK_POLYGON, representation, points,
    ...
    if (numStrips > 0)
      ...
      this->WriteAnAppearance(anActor, writeEmissiveColor, writer);
      // Write Geometry
      vtkmpjX3DExporterWriterRenderFaceSet(VTK_TRIANGLE_STRIP,
    ...
    if (numLines > 0)
      ...
      this->WriteAnAppearance(anActor, writeEmissiveColor, writer);
      // Write Geometry
      vtkmpjX3DExporterWriterRenderFaceSet(VTK_POLY_LINE,
    ...
    if (numVerts > 0)
      ...
      writer->StartNode(Shape);
      this->WriteAnAppearance(anActor, writeEmissiveColor, writer);
      vtkmpjX3DExporterWriterRenderVerts(
        points, verts,
...
//----------------------------------------------------------------------------
void vtkmpjX3DExporter::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkmpjX3DExporter::WriteATextActor2D(vtkActor2D *anTextActor2D,
  vtkX3DExporterWriter* writer)
{
  char *ds;
  vtkTextActor *ta;
...
void vtkmpjX3DExporter::WriteAnAppearance(vtkActor *anActor, bool emissive,
  vtkX3DExporterWriter* writer)
{
  double tempd[3];
  double tempf2;
...
void vtkmpjX3DExporter::WriteATexture(vtkActor *anActor,
  vtkX3DExporterWriter* writer)
{
...
//----------------------------------------------------------------------------
int vtkmpjX3DExporter::HasHeadLight(vtkRenderer* ren)
{
  // make sure we have a default light
  // if we dont then use a headlight
...
//----------------------------------------------------------------------------
char *vtkmpjX3DExporter::RegisterAndGetOutputString()
{
