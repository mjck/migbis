#include "vtkmpjImageExtractComponents.h"
...
vtkStandardNewMacro(vtkmpjImageExtractComponents);

//----------------------------------------------------------------------------
vtkmpjImageExtractComponents::vtkmpjImageExtractComponents()
{
...
//----------------------------------------------------------------------------
void vtkmpjImageExtractComponents::SetFrameInterval(int start, int end)
{
...
//----------------------------------------------------------------------------
void vtkmpjImageExtractComponents::SetFrameNumber(int frame)
{
...
int vtkmpjImageExtractComponents::RequestInformation (
...
//----------------------------------------------------------------------------
template <class T>
void vtkmpjImageExtractComponentsExecute(vtkmpjImageExtractComponents *self,
...
void vtkmpjImageExtractComponents::ThreadedExecute (vtkImageData *inData, 
                                                ...
                                                int outExt[6], int id)
{
  ...
  switch (inData->GetScalarType())
    {
    vtkTemplateMacro(
      vtkmpjImageExtractComponentsExecute(this, inData, 
...
void vtkmpjImageExtractComponents::PrintSelf(ostream& os, vtkIndent indent)
{
