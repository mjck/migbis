/*=========================================================================
  ...
  Module:    vtkmpjImageThresholdConnectivity.h
...
=========================================================================*/
// .NAME vtkmpjImageThresholdConnectivity - Flood fill an image region.
// .SECTION Description
// vtkmpjImageThresholdConnectivity will perform a flood fill on an image,
...
#ifndef __vtkmpjImageThresholdConnectivity_h
#define __vtkmpjImageThresholdConnectivity_h
...
class vtkmpjImageThresholdConnectivity :
  public vtkImageAlgorithm
{
public:
  static vtkmpjImageThresholdConnectivity *New();
  vtkTypeMacro(vtkmpjImageThresholdConnectivity, vtkImageAlgorithm);
...
protected:
  vtkmpjImageThresholdConnectivity();
  ~vtkmpjImageThresholdConnectivity();
...
private:
  vtkmpjImageThresholdConnectivity(const vtkmpjImageThresholdConnectivity&);  // Not implemented.
  void operator=(const vtkmpjImageThresholdConnectivity&);  // Not implemented.
};
