/*=========================================================================
  ...
  Module:    vtkmpjImageThresholdConnectivity.cxx
...
#include "vtkmpjImageThresholdConnectivity.h"
...
vtkStandardNewMacro(vtkmpjImageThresholdConnectivity);
vtkCxxSetObjectMacro(vtkmpjImageThresholdConnectivity, SeedPoints, vtkPoints);

//----------------------------------------------------------------------------
// Constructor sets default values
vtkmpjImageThresholdConnectivity::vtkmpjImageThresholdConnectivity()
{
...
//----------------------------------------------------------------------------
void vtkmpjImageThresholdConnectivity::SetInValue(double val)
{
...
//----------------------------------------------------------------------------
void vtkmpjImageThresholdConnectivity::SetOutValue(double val)
{
...
void vtkmpjImageThresholdConnectivity::ThresholdByUpper(double thresh)
{
...
void vtkmpjImageThresholdConnectivity::ThresholdByLower(
  double thresh)
{
...
void vtkmpjImageThresholdConnectivity::ThresholdBetween(
...
//----------------------------------------------------------------------------
int vtkmpjImageThresholdConnectivity::FillInputPortInformation(
...
//----------------------------------------------------------------------------
//void vtkmpjImageThresholdConnectivity::SetStencil(vtkImageStencilData *stencil)
//{
//  this->SetInput(1, stencil);
//}

//----------------------------------------------------------------------------
//vtkImageStencilData *vtkmpjImageThresholdConnectivity::GetStencil()
//{
...
//----------------------------------------------------------------------------
unsigned long vtkmpjImageThresholdConnectivity::GetMTime()
{
...
template <class IT>
void vtkmpjImageThresholdConnectivityThresholds(
  vtkmpjImageThresholdConnectivity *self,
...
template <class OT>
void vtkmpjImageThresholdConnectivityValues(
  vtkmpjImageThresholdConnectivity *self,
...
//----------------------------------------------------------------------------
/*void vtkmpjImageThresholdConnectivityApplyStencil(
...
void vtkmpjImageThresholdConnectivityExecute(
  vtkmpjImageThresholdConnectivity *self,
  ...
  int &voxelCount)
{
  ...
  vtkmpjImageThresholdConnectivityThresholds(
  ...
  OT inValue, outValue;
  vtkmpjImageThresholdConnectivityValues(self, outData, inValue, outValue);
  ...
  //else
    ...
    //vtkmpjImageThresholdConnectivityApplyStencil(maskData, stencil, extent);
    //}
...
//----------------------------------------------------------------------------
int vtkmpjImageThresholdConnectivity::RequestUpdateExtent(
...
//----------------------------------------------------------------------------
int vtkmpjImageThresholdConnectivity::RequestData(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
  ...
  switch (inData->GetScalarType())
    ...
    vtkTemplateAliasMacro(
      vtkmpjImageThresholdConnectivityExecute(
        this, inData, outData, maskData, outExt, id,
...
//----------------------------------------------------------------------------
void vtkmpjImageThresholdConnectivity::PrintSelf(ostream& os, vtkIndent indent)
{
