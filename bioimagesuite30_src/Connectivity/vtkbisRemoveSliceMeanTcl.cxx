// tcl wrapper for vtkbisRemoveSliceMean object
//
...
{
  vtkbisRemoveSliceMean *temp = vtkbisRemoveSliceMean::New();
  return static_cast<ClientData>(temp);
}

int vtkSimpleImageToImageFilterCppCommand(vtkSimpleImageToImageFilter *op, Tcl_Interp *interp,
             int argc, char *argv[]);
int VTKTCL_EXPORT vtkbisRemoveSliceMeanCppCommand(vtkbisRemoveSliceMean *op, Tcl_Interp *interp,
             int argc, char *argv[]);

int VTKTCL_EXPORT vtkbisRemoveSliceMeanCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[])
{
  if ((argc == 2)&&(!strcmp("Delete",argv[1]))&& !vtkTclInDelete(interp))
   ...
   return vtkbisRemoveSliceMeanCppCommand(static_cast<vtkbisRemoveSliceMean *>(static_cast<vtkTclCommandArgStruct *>(cd)->Pointer),interp, argc, argv);
}
             ...
             int argc, char *argv[])
{
  ...
  if (!interp)
    ...
    if (!strcmp("DoTypecasting",argv[0]))
      {
      if (!strcmp("vtkbisRemoveSliceMean",argv[1]))
        {
  ...
  if ((!strcmp("New",argv[1]))&&(argc == 2))
    {
    vtkbisRemoveSliceMean  *temp20;
    temp20 = (op)->New();
      vtkTclGetObjectFromPointer(interp,(void *)(temp20),"vtkbisRemoveSliceMean");
    return TCL_OK;
    }
  ...
  if (!strcmp("ListInstances",argv[1]))
    {
    vtkTclListInstances(interp,(ClientData)(vtkbisRemoveSliceMeanCommand));
    return TCL_OK;
    }
  ...
  if (!strcmp("ListMethods",argv[1]))
    ...
    Tcl_AppendResult(interp,"Methods from vtkbisRemoveSliceMean:\n",NULL);
  ...
  Tcl_DStringFree ( &dStringParent );
    ...
    Tcl_DStringAppendElement ( &dString, "static vtkbisRemoveSliceMean *New();" );
    Tcl_DStringAppendElement ( &dString, "vtkbisRemoveSliceMean" );
    /* Closing for New */
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkbisRemoveSliceMean *NewInstance();" );
    Tcl_DStringAppendElement ( &dString, "vtkbisRemoveSliceMean" );
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkbisRemoveSliceMean *SafeDownCast(vtkObject* o);" );
    Tcl_DStringAppendElement ( &dString, "vtkbisRemoveSliceMean" );
