// tcl wrapper for vtkbisfmriToolBoxOptimize object
//
...
{
  vtkbisfmriToolBoxOptimize *temp = vtkbisfmriToolBoxOptimize::New();
  return static_cast<ClientData>(temp);
}

int vtkSimpleImageToImageFilterCppCommand(vtkSimpleImageToImageFilter *op, Tcl_Interp *interp,
             int argc, char *argv[]);
int VTKTCL_EXPORT vtkbisfmriToolBoxOptimizeCppCommand(vtkbisfmriToolBoxOptimize *op, Tcl_Interp *interp,
             int argc, char *argv[]);

int VTKTCL_EXPORT vtkbisfmriToolBoxOptimizeCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[])
{
  if ((argc == 2)&&(!strcmp("Delete",argv[1]))&& !vtkTclInDelete(interp))
   ...
   return vtkbisfmriToolBoxOptimizeCppCommand(static_cast<vtkbisfmriToolBoxOptimize *>(static_cast<vtkTclCommandArgStruct *>(cd)->Pointer),interp, argc, argv);
}
             ...
             int argc, char *argv[])
{
  ...
  if (!interp)
    ...
    if (!strcmp("DoTypecasting",argv[0]))
      {
      if (!strcmp("vtkbisfmriToolBoxOptimize",argv[1]))
        {
  ...
  if ((!strcmp("New",argv[1]))&&(argc == 2))
    {
    vtkbisfmriToolBoxOptimize  *temp20;
    temp20 = (op)->New();
      vtkTclGetObjectFromPointer(interp,(void *)(temp20),"vtkbisfmriToolBoxOptimize");
    return TCL_OK;
    }
  ...
  if (!strcmp("ListInstances",argv[1]))
    {
    vtkTclListInstances(interp,(ClientData)(vtkbisfmriToolBoxOptimizeCommand));
    return TCL_OK;
    }
  ...
  if (!strcmp("ListMethods",argv[1]))
    ...
    Tcl_AppendResult(interp,"Methods from vtkbisfmriToolBoxOptimize:\n",NULL);
  ...
  Tcl_DStringFree ( &dStringParent );
    ...
    Tcl_DStringAppendElement ( &dString, "static vtkbisfmriToolBoxOptimize *New();" );
    Tcl_DStringAppendElement ( &dString, "vtkbisfmriToolBoxOptimize" );
    /* Closing for New */
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkbisfmriToolBoxOptimize *NewInstance();" );
    Tcl_DStringAppendElement ( &dString, "vtkbisfmriToolBoxOptimize" );
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkbisfmriToolBoxOptimize *SafeDownCast(vtkObject* o);" );
    Tcl_DStringAppendElement ( &dString, "vtkbisfmriToolBoxOptimize" );
