...
vtkStandardNewMacro(vtkmpjEllipsoidSource);

//----------------------------------------------------------------------------
vtkmpjEllipsoidSource::vtkmpjEllipsoidSource()
{
	this->XRadius = 1.0;
	this->YRadius = 1.0;
	this->ZRadius = 1.0;
	...
	this->ScalarMode = vtkmpjEllipsoidSource::SCALAR_NONE;
...
//----------------------------------------------------------------------------
void vtkmpjEllipsoidSource::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
	double u = uvw[0];
	double v = uvw[1];
	double *Du = Duvw;
...
//----------------------------------------------------------------------------
void vtkmpjEllipsoidSource::MakeTriangleStrips ( vtkCellArray * strips, int PtsU, int PtsV )
{
  int id1;
  int id2;
...
//----------------------------------------------------------------------------
void vtkmpjEllipsoidSource::Execute()
{
...
//----------------------------------------------------------------------------
void vtkmpjEllipsoidSource::PrintSelf(ostream& os, vtkIndent indent)
{
