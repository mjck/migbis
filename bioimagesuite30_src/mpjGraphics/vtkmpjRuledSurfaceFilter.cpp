/*=========================================================================
  ...
  Module:    vtkmpjRuledSurfaceFilter.cxx
...
=========================================================================*/
#include "vtkmpjRuledSurfaceFilter.h"
...
vtkStandardNewMacro(vtkmpjRuledSurfaceFilter);

vtkmpjRuledSurfaceFilter::vtkmpjRuledSurfaceFilter()
{
...
int vtkmpjRuledSurfaceFilter::RequestData(
...
void  vtkmpjRuledSurfaceFilter::Resample(vtkPolyData *output, vtkPolyData *input,
...
void  vtkmpjRuledSurfaceFilter::PointWalk(vtkPolyData *output, vtkPoints *inPts, 
                                       int npts, vtkIdType *pts,
                                       int npts2, vtkIdType *pts2)
{
  int loc, loc2, next2;
...
const char *vtkmpjRuledSurfaceFilter::GetRuledModeAsString(void)
{
...
void vtkmpjRuledSurfaceFilter::PrintSelf(ostream& os, vtkIndent indent)
{
