...
vtkStandardNewMacro(vtkmpjToroidalSource);

//----------------------------------------------------------------------------
void vtkmpjToroidalSource::Evaluate(double theta, double phi,  
...
vtkmpjToroidalSource::vtkmpjToroidalSource(int res)
{
  res = res < 4 ? 4 : res;
...
void vtkmpjToroidalSource::SetPhiResolution(int i)
{
  if(i < 4)
    {
    i = 4;
...
void vtkmpjToroidalSource::SetThetaResolution(int i)
{
  if(i < 8)
    {
    i = 8;
...
void vtkmpjToroidalSource::Execute()
{
...
void vtkmpjToroidalSource::PrintSelf(ostream& os, vtkIndent indent)
{
