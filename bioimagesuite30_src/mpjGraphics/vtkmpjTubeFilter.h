...
public:
  ...
  // Description:
  // Set the eigenvector/value used for scaling.
  ...
  // Description:
  // Set the scale for eigenvalue of normal eigenvector
  vtkSetMacro(NormalScale,float);
  vtkGetMacro(NormalScale,float);

  // Description:
  // Set the scale for eigenvalue of binormal eigenvector
...
protected:
  ...
  int NormalEigenvector; // Normal eigenvector
  int BinormalEigenvector; // Binormal eigenvector
  float NormalScale;
  float BinormalScale;
