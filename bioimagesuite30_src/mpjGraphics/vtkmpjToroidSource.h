...
#ifndef __vtkmpjToroidSource_h
#define __vtkmpjToroidSource_h
...
class vtkmpjToroidSource : public vtkPolyDataSource 
{
public:
  vtkTypeMacro(vtkmpjToroidSource,vtkPolyDataSource);
...
protected:
 ...
 private:    
  ...
  vtkmpjToroidSource(const vtkmpjToroidSource&);  // Not implemented.
  void operator=(const vtkmpjToroidSource&);  // Not implemented.
};
