/*=========================================================================
  ...
  Module:    $RCSfile: vtkmpjGlyph3D.h,v $
...
=========================================================================*/
// .NAME vtkmpjGlyph3D - copy oriented and scaled glyph geometry to every input point
// .SECTION Description
// vtkmpjGlyph3D is a filter that copies a geometric representation (called
...
#ifndef __vtkmpjGlyph3D_h
#define __vtkmpjGlyph3D_h
...
#define VTK_USE_BINORMAL 2
#define VTK_VECTOR_ROTATION_OFF 3

#define VTK_INDEXING_OFF 0
#define VTK_INDEXING_BY_SCALAR 1
#define VTK_INDEXING_BY_VECTOR 2

class vtkmpjGlyph3D : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkmpjGlyph3D,vtkPolyDataAlgorithm);
  ...
  void SetVectorModeToUseBinormal() {this->SetVectorMode(VTK_USE_BINORMAL);};
...
protected:
  ...
  int VectorMode; // Orient/scale via normal, binormal or via vector data
...
private:
  vtkmpjGlyph3D(const vtkmpjGlyph3D&);  // Not implemented.
  void operator=(const vtkmpjGlyph3D&);  // Not implemented.
};

// Description:
// Return the method of scaling as a descriptive character string.
inline const char *vtkmpjGlyph3D::GetScaleModeAsString(void)
{
...
inline const char *vtkmpjGlyph3D::GetColorModeAsString(void)
{
...
inline const char *vtkmpjGlyph3D::GetVectorModeAsString(void)
{
  ...
  else if ( this->VectorMode == VTK_USE_BINORMAL) 
    {
    return "UseBinormal";
    }
  else {
...
inline const char *vtkmpjGlyph3D::GetIndexModeAsString(void)
{
