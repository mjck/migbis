/*=========================================================================
  ...
  Module:    $RCSfile: vtkmpjGlyph3D.cxx,v $
...
vtkCxxRevisionMacro(vtkmpjGlyph3D, "$Revision: 1.124 $");
vtkStandardNewMacro(vtkmpjGlyph3D);
...
void vtkmpjGlyph3D::SetSourceConnection(int id, vtkAlgorithmOutput* algOutput)
{
  if (id < 0)
    {
...
//----------------------------------------------------------------------------
// Specify a source object at a specified table location.
void vtkmpjGlyph3D::SetSource(int id, vtkPolyData *pd)
{
  if (id < 0)
    {
    vtkErrorMacro("Bad index " << id << " for source.");
...
vtkPolyData *vtkmpjGlyph3D::GetSource(int id)
{
...
//----------------------------------------------------------------------------
void vtkmpjGlyph3D::PrintSelf(ostream& os, vtkIndent indent)
{
...
int vtkmpjGlyph3D::RequestUpdateExtent(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
...
//----------------------------------------------------------------------------
vtkPolyData* vtkmpjGlyph3D::GetSource(int idx, vtkInformationVector *sourceInfo)
{
...
//----------------------------------------------------------------------------
int vtkmpjGlyph3D::FillInputPortInformation(int port, vtkInformation *info)
{
  if (port == 0)
    {
