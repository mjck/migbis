// tcl wrapper for vtkpxTPSRPMRegistration object
//
...
{
  vtkpxTPSRPMRegistration *temp = vtkpxTPSRPMRegistration::New();
  return static_cast<ClientData>(temp);
}

int vtkpxAbstractRPMRegistrationCppCommand(vtkpxAbstractRPMRegistration *op, Tcl_Interp *interp,
             int argc, char *argv[]);
int VTKTCL_EXPORT vtkpxTPSRPMRegistrationCppCommand(vtkpxTPSRPMRegistration *op, Tcl_Interp *interp,
             int argc, char *argv[]);

int VTKTCL_EXPORT vtkpxTPSRPMRegistrationCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[])
{
  if ((argc == 2)&&(!strcmp("Delete",argv[1]))&& !vtkTclInDelete(interp))
   ...
   return vtkpxTPSRPMRegistrationCppCommand(static_cast<vtkpxTPSRPMRegistration *>(static_cast<vtkTclCommandArgStruct *>(cd)->Pointer),interp, argc, argv);
}
             ...
             int argc, char *argv[])
{
  ...
  if (!interp)
    ...
    if (!strcmp("DoTypecasting",argv[0]))
      {
      if (!strcmp("vtkpxTPSRPMRegistration",argv[1]))
        {
  ...
  if ((!strcmp("New",argv[1]))&&(argc == 2))
    {
    vtkpxTPSRPMRegistration  *temp20;
    temp20 = (op)->New();
      vtkTclGetObjectFromPointer(interp,(void *)(temp20),"vtkpxTPSRPMRegistration");
    return TCL_OK;
    }
  ...
  if (!strcmp("ListInstances",argv[1]))
    {
    vtkTclListInstances(interp,(ClientData)(vtkpxTPSRPMRegistrationCommand));
    return TCL_OK;
    }
  ...
  if (!strcmp("ListMethods",argv[1]))
    ...
    Tcl_AppendResult(interp,"Methods from vtkpxTPSRPMRegistration:\n",NULL);
  ...
  Tcl_DStringFree ( &dStringParent );
    ...
    Tcl_DStringAppendElement ( &dString, "static vtkpxTPSRPMRegistration *New();" );
    Tcl_DStringAppendElement ( &dString, "vtkpxTPSRPMRegistration" );
    /* Closing for New */
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkpxTPSRPMRegistration *NewInstance();" );
    Tcl_DStringAppendElement ( &dString, "vtkpxTPSRPMRegistration" );
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkpxTPSRPMRegistration *SafeDownCast(vtkObject* o);" );
    Tcl_DStringAppendElement ( &dString, "vtkpxTPSRPMRegistration" );
