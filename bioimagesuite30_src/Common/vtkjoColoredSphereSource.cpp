        ...
        vtkInformationVector* outputVector)
{
	...
	if (this->UseNewWedges){
	  ...
	  //	  fprintf(stderr, "center: {[%.1f, %.1f, %.1f]}\np: {[%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]}\nopp: {[%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]}\ncentroid: {[%.1f, %.1f, %.1f]}\nq: {[%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]; [%.1f, %.1f, %.1f]}\n", this->Center[0], this->Center[1], this->Center[2], p0[0], p0[1], p0[2], p1[0], p1[1], p1[2], p2[0], p2[1], p2[2], opp0[0], opp0[1], opp0[2], opp1[0], opp1[1], opp1[2], opp2[0], opp2[1], opp2[2], centroid[0], centroid[1], centroid[2], q0[0], q0[1], q0[2], q1[0], q1[1], q1[2], q2[0], q2[1], q2[2]);
	}
