...
package provide mpjfibertrackingold 1.2
...
itcl::class mpjfibertrackingold {
...
#  Close window 
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::DismissWindow { } {
...
#  Initialize tool
# -------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::InitializeControl { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::initialize_glyphs { } {
...
#  PRIVATE: Load mask
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::loadmask { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::LoadMask { fname } {
...
#  PRIVATE: Load map
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::loadmap { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::LoadMap { fname } {
...
#  PRIVATE: Load tensor
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::loadtensor { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::LoadTensor { fname } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::SetResultPreffix { preffix } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::GetResultPreffix { } {
    return $global_list(result_fpreffix)
}

itcl::body mpjfibertrackingold::SetCurrentDirectory { fname } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::ClearAllResults { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::SaveAllResults { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::loadresult { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::SaveResult { index } {        
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::saveresult { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::DisplayResult { index { mode image } } {
    # -------------------------------------D---
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::displayresult { { mode image } } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::toggleresult { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::result_clear { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_clear_display { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_update_display { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_toggle_colorbar { } {
...
#  View fiber bundle
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_create_fiber_glyph { index } {
...
#  View fibers
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_create_fibers { } {    
...
#  View colorbar
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_create_colorbar { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::track_seedtype_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::track_regionfilter_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_directionscheme_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::track_integration_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::track_eigenvector_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_update_crosshair_cb { args } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_toggle_trackexplore { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_update_display_cb { } { 
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_glyphsize_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_pointsize_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_cmapresetbtn_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_cmaploadbtn_cb { } {   
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_cmapsavebtn_cb { } {   
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_colormap_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_glyph_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_fiber_filter_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::view_toggle_fiber { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_color_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_selection_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_name_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_display_cb { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_addwithname { name polydata } {
...
#  PRIVATE: Add fiber
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_add { polydata } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_clear { } {
...
#  PUBLIC: Remove fiber
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_remove { index } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_removeselected { } {
...
#  PRIVATE: load fiber
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_load { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_save { index name } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_saveselected { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_saveall { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_savestatistics { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_beginstatistics { title overwrite } {   
...
#  PRIVATE: compute fiber statistics
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_addstatistics { title results tag } {   
...
#  PRIVATE: compute fiber statistics
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_statistics { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_filterangle { } {
...
#  PRIVATE: quantize fibers
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_quantize { } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_explore { cx cy cz } {
...
#  PRIVATE: fiber track
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::fiber_track { } {
    ...
    ## initialize streamer
    set streamer [ vtkmpjTensorStreamOld [ pxvtable::vnewobj ] ]
    $this SetFilterCallbacks $streamer "Fiber tracking..."
    $streamer SetInput [ $map GetImage ]
    $streamer SetTensor [ $tensor GetImage ]
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateInputControl { base } {   
...
#  Create results control
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateResultsControl { base } {   
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateDirectionControl { base } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateTrackingControl { base } {
...
#  Create fiber tracking control
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateFiberControl { base } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateStatisticsControl { base } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateFiberDisplayControl { base } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateDisplayControl { base } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::Initialize { widget } {
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::CreateMenu { mb } {    
...
# ------------------------------------------------------------------------------------------
itcl::body mpjfibertrackingold::AddToMenuButton { mb args } {
