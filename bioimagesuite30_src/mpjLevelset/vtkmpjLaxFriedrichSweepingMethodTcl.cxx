// tcl wrapper for vtkmpjLaxFriedrichSweepingMethod object
//
...
{
  vtkmpjLaxFriedrichSweepingMethod *temp = vtkmpjLaxFriedrichSweepingMethod::New();
  return static_cast<ClientData>(temp);
}

int vtkpxSimpleImageToImageFilterCppCommand(vtkpxSimpleImageToImageFilter *op, Tcl_Interp *interp,
             int argc, char *argv[]);
int VTKTCL_EXPORT vtkmpjLaxFriedrichSweepingMethodCppCommand(vtkmpjLaxFriedrichSweepingMethod *op, Tcl_Interp *interp,
             int argc, char *argv[]);

int VTKTCL_EXPORT vtkmpjLaxFriedrichSweepingMethodCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[])
{
  if ((argc == 2)&&(!strcmp("Delete",argv[1]))&& !vtkTclInDelete(interp))
   ...
   return vtkmpjLaxFriedrichSweepingMethodCppCommand(static_cast<vtkmpjLaxFriedrichSweepingMethod *>(static_cast<vtkTclCommandArgStruct *>(cd)->Pointer),interp, argc, argv);
}
             ...
             int argc, char *argv[])
{
  ...
  if (!interp)
    ...
    if (!strcmp("DoTypecasting",argv[0]))
      {
      if (!strcmp("vtkmpjLaxFriedrichSweepingMethod",argv[1]))
        {
  ...
  if ((!strcmp("New",argv[1]))&&(argc == 2))
    {
    vtkmpjLaxFriedrichSweepingMethod  *temp20;
    temp20 = (op)->New();
      vtkTclGetObjectFromPointer(interp,(void *)(temp20),"vtkmpjLaxFriedrichSweepingMethod");
    return TCL_OK;
    }
  ...
  if (!strcmp("ListInstances",argv[1]))
    {
    vtkTclListInstances(interp,(ClientData)(vtkmpjLaxFriedrichSweepingMethodCommand));
    return TCL_OK;
    }
  ...
  if (!strcmp("ListMethods",argv[1]))
    ...
    Tcl_AppendResult(interp,"Methods from vtkmpjLaxFriedrichSweepingMethod:\n",NULL);
  ...
  Tcl_DStringFree ( &dStringParent );
    ...
    Tcl_DStringAppendElement ( &dString, "static vtkmpjLaxFriedrichSweepingMethod *New();" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweepingMethod" );
    /* Closing for New */
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweepingMethod *NewInstance();" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweepingMethod" );
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweepingMethod *SafeDownCast(vtkObject* o);" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweepingMethod" );
