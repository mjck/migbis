...
class vtkmpjFastMarchingConnectivity : public vtkpxSimpleImageToImageFilter
{
 ...
 protected:
  ...
  virtual double ComputeSpeed(vtkImageData *input, vtkImageData *output, int parent, int coord[3], int index, float direction[3]);  
  virtual double ComputeFirstOrder(vtkImageData *input, vtkImageData *output, int parent, int coord[3], int index);
  virtual void ComputeNormal(vtkImageData *input, vtkImageData *output, int coord[3], int index, float result[3]);
