// tcl wrapper for vtkmpjLaxFriedrichSweeping object
//
...
{
  vtkmpjLaxFriedrichSweeping *temp = vtkmpjLaxFriedrichSweeping::New();
  return static_cast<ClientData>(temp);
}

int vtkpxSimpleImageToImageFilterCppCommand(vtkpxSimpleImageToImageFilter *op, Tcl_Interp *interp,
             int argc, char *argv[]);
int VTKTCL_EXPORT vtkmpjLaxFriedrichSweepingCppCommand(vtkmpjLaxFriedrichSweeping *op, Tcl_Interp *interp,
             int argc, char *argv[]);

int VTKTCL_EXPORT vtkmpjLaxFriedrichSweepingCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[])
{
  if ((argc == 2)&&(!strcmp("Delete",argv[1]))&& !vtkTclInDelete(interp))
   ...
   return vtkmpjLaxFriedrichSweepingCppCommand(static_cast<vtkmpjLaxFriedrichSweeping *>(static_cast<vtkTclCommandArgStruct *>(cd)->Pointer),interp, argc, argv);
}
             ...
             int argc, char *argv[])
{
  ...
  if (!interp)
    ...
    if (!strcmp("DoTypecasting",argv[0]))
      {
      if (!strcmp("vtkmpjLaxFriedrichSweeping",argv[1]))
        {
  ...
  if ((!strcmp("New",argv[1]))&&(argc == 2))
    {
    vtkmpjLaxFriedrichSweeping  *temp20;
    temp20 = (op)->New();
      vtkTclGetObjectFromPointer(interp,(void *)(temp20),"vtkmpjLaxFriedrichSweeping");
    return TCL_OK;
    }
  ...
  if (!strcmp("ListInstances",argv[1]))
    {
    vtkTclListInstances(interp,(ClientData)(vtkmpjLaxFriedrichSweepingCommand));
    return TCL_OK;
    }
  ...
  if (!strcmp("ListMethods",argv[1]))
    ...
    Tcl_AppendResult(interp,"Methods from vtkmpjLaxFriedrichSweeping:\n",NULL);
  ...
  Tcl_DStringFree ( &dStringParent );
    ...
    Tcl_DStringAppendElement ( &dString, "static vtkmpjLaxFriedrichSweeping *New();" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweeping" );
    /* Closing for New */
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweeping *NewInstance();" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweeping" );
    ...
    Tcl_DStringAppendElement ( &dString, "" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweeping *SafeDownCast(vtkObject* o);" );
    Tcl_DStringAppendElement ( &dString, "vtkmpjLaxFriedrichSweeping" );
