...
//------------------------------------------------------------------------------
vtkmpjLevelSetDistance* vtkmpjLevelSetDistance::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkmpjLevelSetDistance");
  if (ret) {
    return (vtkmpjLevelSetDistance*)ret;
  }
  // If the factory was unable to create the object, then create it here.
  return new vtkmpjLevelSetDistance;
}

// Construct object with no children.
vtkmpjLevelSetDistance::vtkmpjLevelSetDistance()
{
  this->LevelSetValue = 0.0;
  this->LevelSetMask = NULL;
}
...
// ----------------------------------------------------------------------------
void vtkmpjLevelSetDistance::ExecuteInformation()
{
...
// ----------------------------------------------------------------------------
void vtkmpjLevelSetDistance::Sort(double values[3]) 
{
  double tmp[3];
...
// ----------------------------------------------------------------------------
double vtkmpjLevelSetDistance::ComputeDistance(vtkImageData *input, int coord[3], int index)
{
...
// ----------------------------------------------------------------------------
void vtkmpjLevelSetDistance::SimpleExecute(vtkImageData *input, vtkImageData *output)
{
  vtkDataArray *in = input->GetPointData()->GetScalars();
